...
-- Combined basic relations (no need for separate insert_rel/remove_rel views)
...
-- Recursive view for nextSiblingAnc
CREATE RECURSIVE VIEW nextSiblingAnc(StartCtr, StartN, NextCtr, NextN) AS (
...
-- Combined nextElem and value logic
CREATE VIEW nextElem AS 
-- Case 1: first child  
...
-- Combined value assignment and visibility
...
-- Recursive view for skipBlank
CREATE RECURSIVE VIEW skipBlank(FromCtr, FromN, ToCtr, ToN) AS (
